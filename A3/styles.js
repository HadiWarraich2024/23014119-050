document.addEventListener('DOMContentLoaded', function() {
    // Apply styles to the registration page
    ...
    // Apply styles to the login page
    if (document.querySelector('form[action="page1.html"]')) {
        const body = document.body;
    ...
    // Apply styles to portfolio pages
    if (document.querySelector('header.navbar')) {
        ...
        if (document.querySelector('.profile')) {
            ...
            const profileH2 = profileContent.querySelector('h2');
        ...
        // Favorite bikes section
        const eighth = document.querySelector('.eigth');
        if (eighth) {
            eighth.style.padding = '20px';
            eighth.style.fontSize = '20px';
        }

        // Contact section
        const sixth = document.querySelector('.sixth');
        if (sixth) {
            sixth.style.padding = '20px';
            sixth.style.fontSize = '20px';
        }

        // Address section
        const fifth = document.querySelector('.fifth');
        if (fifth) {
            fifth.style.padding = '20px';
            fifth.style.fontSize = '20px';
        }

        // Education section
        const seventh = document.querySelector('.seventh');
        if (seventh) {
            seventh.style.padding = '20px';
            seventh.style.fontSize = '20px';
        }

        // Contact picture section
        const contPic = document.querySelector('.cont-pic');
        if (contPic) {
            contPic.style.textAlign = 'center';
            contPic.style.margin = '20px 0';
            contPic.style.padding = '20px';

            const contPicImg = contPic.querySelector('img');
            if (contPicImg) {
                contPicImg.style.maxWidth = '100%';
                contPicImg.style.height = 'auto';
                contPicImg.style.borderRadius = '10px';
                contPicImg.style.boxShadow = '0 4px 10px rgba(0, 0, 0, 0.1)';
            }
        }
        ...
        function handleResize() {
            if (window.innerWidth <= 768) {
                ...
                const sections = [skills, eighth, fifth, sixth, seventh];
